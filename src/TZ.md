...
<ul style="text-align: justify">
  <li>
    Модуль данных: Загрузка рентген-снимков, сохранение сцены
  </li>
  <li>
    Модуль анализа изображений: Анализ рентген-снимков искусственным интеллектом, выделение углов наклона позвонков в позвоночнике.
  </li>
  <li>
    Модуль 3D-моделирования: Отображение модели, генерация прогнозируемого позвоночника, смена текстурной карты.
  </li>
  <li>
    Модуль прогнозирования: Сравнение выделенных углов наклона с углами, характерными для болезней в базе данных.
  </li>
  <li>
    Модуль отчетности: Создание отчёта, включающего  себя углы наклона всех позвонков, тип сцены и выявленную болезнь
  </li>
</ul>
